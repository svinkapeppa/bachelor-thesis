...
\hypersetup{
    ...
    pdfauthor={Рубаненко Евгений},
    pdftitle={Использование ручных признаков в решении задачи NER}
}
...
\titleformat{\subsection}[block]{\centering\vspace{1em}}{}{12.5mm}{\thesubsection\quad#1\vspace{1em}}
